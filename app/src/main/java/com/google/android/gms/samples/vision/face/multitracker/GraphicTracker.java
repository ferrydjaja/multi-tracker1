...
class GraphicTracker<T> extends Tracker<T> {
    ...
    public interface BarcodeUpdateListener {
        @UiThread
        void onBarcodeDetectedA(Detector.Detections item);
        void onBarcodeDetectedB(Barcode barcode);
    }
    ...
    public void onUpdate(Detector.Detections<T> detectionResults, T item) {
        ...
        //mBarcodeUpdateListener.onBarcodeDetected(detectionResults, item);

        if(item instanceof TextBlock )
            mBarcodeUpdateListener.onBarcodeDetectedA(detectionResults);
        else
            mBarcodeUpdateListener.onBarcodeDetectedB((Barcode) item);
